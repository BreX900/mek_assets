    ...
    $checkedCreate('Pubspec', json, ($checkedConvert) {
      final val = Pubspec(
        environment: $checkedConvert(
          'environment',
          (v) => PubspecEnvironment.fromJson(v as Map),
        ),
...
PubspecEnvironment _$PubspecEnvironmentFromJson(Map json) =>
    $checkedCreate('PubspecEnvironment', json, ($checkedConvert) {
      final val = PubspecEnvironment(
        sdk: $checkedConvert(
          'sdk',
          (v) => PubspecEnvironment._parseVersion(v as String),
        ),
      );
      return val;
    });
...
Flutter _$FlutterFromJson(Map json) =>
    $checkedCreate('Flutter', json, ($checkedConvert) {
      final val = Flutter(
        assets: $checkedConvert(
          'assets',
          (v) =>
              (v as List<dynamic>?)?.map(FlutterAsset.fromJson).toList() ??
              const <FlutterAsset>[],
        ),
      );
      return val;
...
FlutterAsset _$FlutterAssetFromJson(Map json) => $checkedCreate(
  'FlutterAsset',
  json,
  ($checkedConvert) {
